...
const SidebarNavItem = (props: SidebarNavItemProps) => {
  ...
  return (
    <Nav.Item>
      <Nav.Link className="px-3 py-2 d-flex align-items-center" as={Link} to={href}>
...
export default function SidebarNav() {
  return (
    <ul className="list-unstyled">
      <SidebarNavTitle>Metrics</SidebarNavTitle>
      <SidebarNavItem icon={faChartPie} href="#">Summary</SidebarNavItem>
      <SidebarNavItem icon={faMagnifyingGlassChart} href="#">Items</SidebarNavItem>
    </ul>
  )
}
